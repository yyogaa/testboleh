				...
				<div class="col-md-9 top-in-single">
						...
						<ul id="etalage">
							<li>
								<a href="optionallink.html">
									<img class="etalage_thumb_image img-responsive" src="images/112.jpg" alt="" >
									<img class="etalage_source_image img-responsive" src="images/112.jpg" alt="" >
								</a>
							</li>
						</ul>
					...
					<div class="col-md-7 single-top-in">
						<div class="single-para">
							<h4>Kaos I Love Bogor </h4>
							<p>Kaos I love Bogor merupakan kaos dengan jenis bahan katun combed 20s, bahan ini cocok untuk dipakai sehari-hari, lembut, nyaman, dan menyerap keringat. Bisa beli satuan tanpa minimum order . Tersedia paket hemat kaos polos diskon 5% untuk pembelian 1 lusin produk kaos polos atau sweater polos apa saja. Bagi yang mau belanja grosir, tersedia harga lusinan yang dijamin murah meriah.</p>
							<div class="star-on">
								<ul>
									<li><a href="#"><i> </i></a></li>
									<li><a href="#"><i> </i></a></li>
							...
							<div class="clearfix"> </div>
								...
								<label  class="add-to">RP. 130.000</label>
						  ...
						  <ul class="resp-tabs-list">
							...
							<div class="resp-tabs-container">
							    <h2 class="resp-accordion resp-tab-active" role="tab" aria-controls="tab_item-0"><span class="resp-arrow"></span>Product Description</h2><div class="tab-1 resp-tab-content resp-tab-content-active" aria-labelledby="tab_item-0" style="display:block">
									<div class="facts">
									  <p > Jahit rantai pada bagian bahu, tanpa merek, cocok untuk sablon kaos manual, sablon digital, atau print DTG. Kami sediakan lebih dari 30 pilihan warna dan dalam ukuran mulai dari S, M, ML (Medium Large atau All Size), L, XL, XXL, sampai XXXL. Ada juga ukuran anak-anak. </p>
