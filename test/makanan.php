		...
		<h2 class="new">NEW ARRIVALS</h2>
			<div class="pink">
				<div class="col-md-3 blue">
					<a href="detail.php" > <img src="images/13.jpg" class="img-responsive" alt=""></a>
					<!---->
						<div class="grid_1 simpleCart_shelfItem">
							<a href="#" class="cup item_add"><span class=" item_price" >RP.20.000 <i> </i> </span></a>
						</div>
					<!---->
				</div>
				<div class="col-md-3 blue">
					<a href="single.html" > <img src="images/14.jpg" class="img-responsive" alt=""></a>
					<!---->
						<div class="grid_1 simpleCart_shelfItem">
							<a href="#" class="cup item_add"><span class=" item_price" >RP.20.000 <i> </i> </span></a>
						</div>
				...
				<div class="col-md-3 blue">
					 <a href="single.html" > <img src="images/20.jpg" class="img-responsive" alt=""></a>
						<!---->
						<div class="grid_1 simpleCart_shelfItem">
							<a href="#" class="cup item_add"><span class=" item_price" > RP.15.000 <i> </i> </span></a>
						</div>
					<!---->
				</div>
				<div class="col-md-3 blue">
					...
					<!---->
						<div class="grid_1 simpleCart_shelfItem">
							<a href="#" class="cup item_add"><span class=" item_price" > RP.13.000 <i> </i> </span></a>
						</div>
					<!---->
				</div>
				<div class="clearfix"> </div>
