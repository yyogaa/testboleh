...
<div class="container">
		...
		<h2 class="new">Cinderamata</h2>
			<div class="pink">
				<div class="col-md-3 blue">
					<a href="detail.php" > <img src="images/111.jpg" class="img-responsive" alt=""></a>
					<!---->
						<div class="grid_1 simpleCart_shelfItem">
							<a href="#" class="cup item_add"><span class=" item_price" >RP.100.000 <i> </i> </span></a>
						</div>
					<!---->
				</div>
				<div class="col-md-3 blue">
					<a href="detail1.php" > <img src="images/112.jpg" class="img-responsive" alt=""></a>
					<!---->
						<div class="grid_1 simpleCart_shelfItem">
							<a href="#" class="cup item_add"><span class=" item_price" >RP.200.000 <i> </i> </span></a>
						</div>
					<!---->
				</div>
				<div class="col-md-3 blue">
					 <a href="single.html" > <img src="images/113.jpg" class="img-responsive" alt=""></a>
						<!---->
						<div class="grid_1 simpleCart_shelfItem">
							<a href="#" class="cup item_add"><span class=" item_price" > RP.150.000.000 <i> </i> </span></a>
						</div>
					<!---->
				</div>
				<div class="col-md-3 blue">
					<a href="single.html" > <img src="images/115.jpg" class="img-responsive" alt=""></a>
					<!---->
						<div class="grid_1 simpleCart_shelfItem">
							<a href="#" class="cup item_add"><span class=" item_price" > RP.130.000 <i> </i> </span></a>
						</div>
					<!---->
				</div>
				<div class="clearfix"> </div>
		...
		<div class="pink">
			<div class="col-md-3 blue">
				 <a href="single.html" > <img src="#" class="img-responsive" alt=""></a>
				<!---->
						<div class="grid_1 simpleCart_shelfItem">
