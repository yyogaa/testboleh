	...
	<div class="container">
		...
		<!-- //requried-jsfiles-for owl -->
			...
			<div class="item">
				<div class=" box-in">
			<div class=" grid_box">
							 <a href="single.html" > <img src="#" class="img-responsive" alt="">
							 	<div class="zoom-icon">
		...
		<div class="col-best">
			<div class="col-md-4">
              ...
              <li><a href="#"><i> </i> </a> </li>
						...
						<!---->
						<a href="#" class="item_add"><span class="white item_price" > RP. 33.000 <i> </i> </span></a>
						<!---->
					</div>
					<div class="clearfix"> </div>
				</div>
			...
			<div class="col-md-4">
				<a href="detail.php"><div class="col-in">
					...
					<div class="col-in-right grid_1 simpleCart_shelfItem">
						...
						<!---->
						<a href="#" class="item_add"><span class="white item_price" >RP. 20.000 <i> </i> </span></a>
						<!---->
					</div>
					<div class="clearfix"> </div>
				</div>
			...
			<div class="col-md-4">
				<a href="detail.php"><div class="col-in">
					...
					<div class="col-in-right grid_1 simpleCart_shelfItem">
						...
						<!---->
						<a href="#" class="item_add"><span class="white item_price" > RP. 15.000 <i> </i> </span></a>
						<!---->
					</div>
					<div class="clearfix"> </div>
				</div>
